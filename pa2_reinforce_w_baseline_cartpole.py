# -*- coding: utf-8 -*-
"""PA2_REINFORCE_w_baseline_Cartpole.ipynb
...
def calculate_td_estimate(rewards,state_vals,gamma):
  td_estimate = np.zeros_like(rewards)
  for t in range(len(rewards)):
    if t == len(rewards)-1:
      td_estimate[t] = rewards[t] - state_vals[t]
    else:
      td_estimate[t] = rewards[t] + gamma*state_vals[t+1] - state_vals[t]
  td_estimate = torch.tensor(td_estimate**2)
  td_estimate = (td_estimate - td_estimate.mean())/td_estimate.std()
  return td_estimate
